          ...
          <ul className="_11hau3k">
            ...
            {props.currentPage > 1 ? (
              <li className='_8wtxgiq'>
                <button className='_1ip5u88' type='button' onClick={props.handlePreviousArrow}>
            ...
            {Object.keys(props.reviewsInPage).map((pageNum, index) => {
              return <li className="_8wtxgiq" key={pageNum}>
              <button
                className="_1wtrbgoo"
                type="button"
            ...
            {/* next page arrow */}
            {props.currentPage < props.numPages ? (<li className="_b8vexar">
              <button
                className="_1ip5u88"
                type="button"
